...
const carouselImages = [
    "/images/books_carousel/abrsm_books.webp",
    "/images/books_carousel/faber books.webp",
]

const imageArr =[trinity]
    ...
    return <div id="default-carousel" className="relative w-full rounded-lg" data-carousel="slide">
        <div className="relative overflow-hidden h-64 md:h-96 rounded-lg">
            ...
            <div className="hidden duration-700 ease-in-out" data-carousel-item>
                <Image alt="trinity books" src={imageArr[0]} className={`absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2`}/>
            </div>
        </div>
        {/* Slider Indicators */}
