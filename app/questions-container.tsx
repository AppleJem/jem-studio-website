    ...
    <div className="self-stretch flex flex-col items-center justify-center text-stone-600">
      ...
      <form className="w-3/4 max-w-2xl lg:w-2/5 flex flex-col items-stretch" onSubmit={handleSubmit}>
        <div className="mb-6">
          ...
          <input autoComplete="true" autoCapitalize="true" type="text" id="name" name="name" className="border-0 border-b border-b-stone-400 text-gray-900 text-sm focus:border-b-yellow-400 focus:ring-0 block w-full py-2.5 px-0" required />
        </div>
        <div className="flex flex-col lg:flex-row gap-x-10">
          <div className="mb-6 grow">
            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email address</label>
            <input autoComplete="true" type="email" id="email" name="email" className="border-0 border-b border-b-stone-400 text-gray-900 text-sm focus:border-b-yellow-400 focus:ring-0 block w-full py-2.5 px-0 " required />
          </div>
          <div className="mb-6 grow">
            <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone</label>
            <input autoComplete="true" type="tel" id="phone" name="phone" className="border-0 border-b border-b-stone-400 text-gray-900 text-sm focus:border-b-yellow-400 focus:ring-0 block w-full py-2.5 px-0" required />
          </div>
        </div>
